...
- [Linly-Talker-Stream: Real-Time Streaming Conversational Digital Human System](#linly-talker-stream-real-time-streaming-conversational-digital-human-system)
  - [News](#news)
  - [Introduction](#introduction)
  - [Why Linly-Talker-Stream?](#why-linly-talker-stream)
  ...
  - [Manual Installation Example (wav2lip)](#manual-installation-example-wav2lip)
    - [Generate HTTPS Certificates (Recommended)](#generate-https-certificates-recommended)
    - [Install Other Avatar Modules](#install-other-avatar-modules)
  - [Startup Methods](#startup-methods)
    - [A. Start Backend and Frontend Separately](#a-start-backend-and-frontend-separately)
    - [B. Start with One Command](#b-start-with-one-command)
